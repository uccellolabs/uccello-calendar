            ...
            <div class="body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>
                            <a class="btn btn-lg btn-primary" href="{{ route('uccello.calendar.signin', ['domain' => $domain->slug, 'type' => 'microsoft']) }}" role="button" id="connect-button">Connect to Outlook</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="body">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Gmail</h1>
                        <p>
                            <a class="btn btn-lg btn-primary" href="{{ route('uccello.calendar.signin', ['domain' => $domain->slug, 'type' => 'google']) }}" role="button" id="connect-button">Connect to Google Calendar</a>
                        </p>
                    </div>
                </div>
            </div>
